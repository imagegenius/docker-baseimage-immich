pipeline {
  ...
  environment {
    ...
    IG_USER = 'imagegenius'
    IG_REPO = 'docker-baseimage-immich'
    CONTAINER_NAME = 'baseimage-immich'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'false'
    CI_WEB = ''
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/imagegenius/docker-baseimage-immich/packages\" \
          --label \"org.opencontainers.image.source=https://github.com/imagegenius/docker-baseimage-immich\" \
          ...
          --label \"org.opencontainers.image.title=Baseimage-immich\" \
          --label \"org.opencontainers.image.description=baseimage-immich image by imagegenius.io\" \
